...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Empirejadecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"empirejadecointools.com", "empirejadecointools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"empirejadecointools.com", "testnet-seed.empirejadecointools.com"},
    {"xurious.com", "testnet-seed.ejc.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Empirejadecoin is probably already running."), addrBind.ToString().c_str());
        else
